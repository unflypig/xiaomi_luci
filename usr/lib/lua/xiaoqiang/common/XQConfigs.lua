...
FORK_RESTART_WIFI_NOW = "/sbin/wifi >/dev/null 2>/dev/null; /etc/init.d/minidlna restart; /etc/init.d/samba restart; /usr/bin/gettraffic flush_wl_dev >/dev/null 2>/dev/null"
FORK_RESTART_WIFI = "sleep 5; " .. FORK_RESTART_WIFI_NOW
